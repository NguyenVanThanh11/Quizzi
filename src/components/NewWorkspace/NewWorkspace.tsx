...
/* @figmaId 5482:25790 */
export const NewWorkspace: FC<Props> = memo(function NewWorkspace(props = {}) {
        ...
        <div className={classes.modal2}>
          <div className={classes.content7}>
              ...
              swap={{
                alertCircle: (
                  <CheckCircle
                    ...
                    swap={{
                      icon: <CheckCircleIcon className={classes.icon15} />,
                    }}
                  />
                ),
              }}
            ...
            <InputField_SizeSmTypeDefaultDe
              ...
              text={{
                label: <div className={classes.label}>Create new workspace</div>,
                text: <input className={classes.text11} placeholder="New workspace" />,
              }}
            />
          </div>
          <_ModalActions_TypeHorizontalFi
            ...
            text={{
              text: <div className={classes.text12}>Save</div>,
            }}
          />
