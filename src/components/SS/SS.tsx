...
import { Modal_TypeStackedLeftAlignedBr } from './Modal_TypeStackedLeftAlignedBr/Modal_TypeStackedLeftAlignedBr.js';
import { Plus } from './Plus/Plus.js';
import { PlusIcon2 } from './PlusIcon2.js';
import { PlusIcon } from './PlusIcon.js';
import classes from './SS.module.css';
...
/* @figmaId 5575:9596 */
export const SS: FC<Props> = memo(function SS(props = {}) {
  return (
    <div className={`${resets.clapyResets} ${classes.root}`}>
      ...
      <div className={classes.input}>
        <div className={classes.content2}>
          <div className={classes.text6}>Quizz 1</div>
        </div>
      </div>
          ...
          <div className={classes.question}>
            <div className={classes.input2}>
              <div className={classes.content4}>
                <div className={classes.text7}>Put your question here</div>
              </div>
            </div>
                ...
                <div className={classes.content5}>
                  ...
                  <div className={classes.textAndSupportingText}>
                    <div className={classes.textAndSubtext}>
                      <div className={classes.text8}>Answer 1</div>
                    </div>
                  </div>
                </div>
              </div>
                ...
                <div className={classes.content6}>
                  ...
                  <div className={classes.textAndSupportingText2}>
                    <div className={classes.textAndSubtext2}>
                      <div className={classes.text9}>Answer 2</div>
                    </div>
                  </div>
                </div>
              </div>
                ...
                <div className={classes.content7}>
                  ...
                  <div className={classes.textAndSupportingText3}>
                    <div className={classes.textAndSubtext3}>
                      <div className={classes.text10}>Answer 3</div>
                    </div>
                  </div>
                </div>
              </div>
                ...
                <div className={classes.content8}>
                  ...
                  <div className={classes.textAndSupportingText4}>
                    <div className={classes.textAndSubtext4}>
                      <div className={classes.text11}>Add new answer</div>
                    </div>
                  </div>
                </div>
              </div>
          ...
          <div className={classes.add}>
            <div className={classes.checkbox}>
              ...
              <div className={classes.textAndSupportingText5}>
                <div className={classes.text12}>Image/Video</div>
              </div>
            </div>
          </div>
          <div className={classes.add2}>
            <div className={classes.checkbox2}>
              ...
              <div className={classes.textAndSupportingText6}>
                <div className={classes.text13}>Comment</div>
              </div>
            </div>
          </div>
          <div className={classes.add3}>
            <div className={classes.checkbox3}>
              ...
              <div className={classes.textAndSupportingText7}>
                <div className={classes.text14}>Time to complete</div>
              </div>
            </div>
          </div>
        </div>
              ...
              <div className={classes.form}>
                ...
                <div className={classes.input10}>
                  <div className={classes.content9}>
                    <div className={classes.text15}>Click to add title</div>
                  </div>
                </div>
                <div className={classes.input11}>
                  <div className={classes.content10}>
                    <div className={classes.text16}>Click to add subtitle</div>
                  </div>
                </div>
          ...
          <div className={classes.textContent}>
            ...
            <div className={classes.content11}>
              <div className={classes.textAndSupportingText8}>
                <div className={classes.text17}>Add question</div>
              </div>
            </div>
          </div>
        </div>
      ...
      <div className={classes.navigation}>
        <div className={classes._NavItemDropdownBase2}>
          <div className={classes._NavItemBase2}>
            <div className={classes.content12}>
              ...
              />
              <div className={classes.text18}>Home</div>
            </div>
          </div>
        </div>
        <div className={classes._NavItemDropdownBase3}>
          <div className={classes._NavItemBase3}>
            <div className={classes.content13}>
              ...
              />
              <div className={classes.text19}>Editor</div>
            </div>
          </div>
        </div>
        <div className={classes._NavItemDropdownBase4}>
          <div className={classes._NavItemBase4}>
            <div className={classes.content14}>
              ...
              />
              <div className={classes.text20}>Design</div>
            </div>
          </div>
        </div>
      ...
      <Modal_TypeStackedLeftAlignedBr
        className={classes.modal}
        classes={{ button: classes.button2 }}
        text={{
          text: <div className={classes.text4}>Saved successfully</div>,
          supportingText: (
            <div className={classes.supportingText}>You can take the newly created quiz when you click on the quiz</div>
          ),
          text2: <div className={classes.text5}>Start</div>,
        }}
      />
    </div>
  );
